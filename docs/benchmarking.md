...
glyphrush --backend auto bench test/ --eval-manifest test/corpus.json --baseline-preset glyphrush-v0 --require-speedup-claim liteparse=2.0 --require-speedup-claim liteparse-no-ocr=1.5
glyphrush bench test/ --eval-manifest test/corpus.json --baseline-preset glyphrush-v0 --require-speedup-claim liteparse=2.0 --require-speedup-claim liteparse-no-ocr=1.5
