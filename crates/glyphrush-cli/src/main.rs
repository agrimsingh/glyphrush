...
fn liteparse_feature_parity_capabilities(
    ...
    vec![
        ...
        FeatureParityCapability {
            ...
            notes: "Glyphrush avoids always-on per-character metadata, preserves full-width bands and conservative short section separators around clearly separated two-column sections when span geometry is available, seeds bounded span-bbox manifest samples, and escalates layout work when signals require it.",
        },
        FeatureParityCapability {
            id: "ocr",
            area: "ocr",
        ...
        FeatureParityCapability {
            ...
            notes: "Current table support is conservative, tied to explicit uncertainty flags, preserves blank cells for delimited text, fixed-width whitespace, header-guided whitespace rows with multi-word descriptor cells, and aligned positioned rows when table recovery is routed, and exposes structured grids to eval text anchors.",
        },
        FeatureParityCapability {
