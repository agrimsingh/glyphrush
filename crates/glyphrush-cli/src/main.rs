...
fn liteparse_feature_parity_capabilities(
    ...
    vec![
        ...
        FeatureParityCapability {
            ...
            notes: "Glyphrush avoids always-on per-character metadata, preserves full-width bands, fragmented full-width heading rows, fragmented middle cross-column bands, leading, middle, and trailing cross-column bands, conservative short section separators, and clearly separated 2-4 column reading order when span geometry is available, seeds bounded span-bbox manifest samples, and escalates layout work when signals require it.",
        },
        FeatureParityCapability {
            id: "ocr",
            area: "ocr",
