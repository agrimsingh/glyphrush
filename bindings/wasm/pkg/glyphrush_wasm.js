/* @ts-self-types="./glyphrush_wasm.d.ts" */
 ...
 * @param {boolean} span_geometry
 * @returns {string}
 */
function parse_pdf_bytes(bytes, span_geometry) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.parse_pdf_bytes(ptr0, len0, span_geometry);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.parse_pdf_bytes = parse_pdf_bytes;
...
const wasmPath = `${__dirname}/glyphrush_wasm_bg.wasm`;
