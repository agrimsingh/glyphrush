...
AWINIC-style electrical tables with `Parameter / Test Condition / Min. / Typ. / Max. / Unit` headers can route table recovery from the native text header alone and normalize wrapped labels, inherited conditions, symbol-font micro units, and unit-only continuation lines into structured cells.
